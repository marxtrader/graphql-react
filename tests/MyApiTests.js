 ...
 * global describe
 */
describe.skip('start testing MyApiTests.js',function() {   
...
xdescribe('destination/1/positions', () => {
    // login first
    beforeEach(() => {
        return doLogin().then(sc => {
            this.sessionCookies = sc;
    ...
    it('destination/1/positions', (done) => {
        request.get(config.orderMgmtRestUrl + 'destination/1/positions')
                .timeout(20000)
                .redirects(0)
                .set('Cookie', this.sessionCookies)
                .set('Accept', 'application/json')
...
xdescribe('GET	/companies/divisions/{id}', () => {
    // login first
    beforeEach(() => {
        return doLogin().then(sc => {
            this.sessionCookies = sc;
